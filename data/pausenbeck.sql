...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 31. Okt 2018 um 16:43
...
(1, 'Butter Brötchen', 1, '1.50'),
(2, 'Schinken Sandwich', 3, '4.50'),
(3, 'Schoggi Gipfeli', 0, '2.50'),
(4, 'Vegi Sandwich', 5, '6.50'),
(5, 'Bauern Brötli', 2, '2.-');
...
(2, 'Nicolas Lachenal', 'nicolas.lachenal@bwdbern.ch', 'bingbong10', 1),
(3, 'vorname nachname', 'test@bwdbern.ch', 'sml12345', 0);
